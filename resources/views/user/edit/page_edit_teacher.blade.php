...
<body>
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <div class="image-preview" id="image-preview">
                            ...
                            <img id="preview-image" src="{{ asset($teacher->picture_url) }}" alt="ตัวอย่างรูปภาพ"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="id_position" name="id_position" required>
                                    ...
                                    <option value="{{ $position->position_id }}"
                                        {{ $teacher->id_position == $position->position_id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="id_aca" name="id_aca" required>
                                    ...
                                    <option value="{{ $academic->academic_id }}"
                                        {{ $teacher->id_aca == $academic->academic_id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="id_sex" name="id_sex" required>
                                    ...
                                    <option value="{{ $sex->sex_id }}"
                                        {{ $teacher->id_sex == $sex->sex_id ? 'selected' : '' }}>
                                        {{ $sex->sex_name }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group text-end">
                        <button type="submit" id="updateTeacherBtn" class="btn btn-primary">บันทึกการแก้ไข</button>
                    </div>
                </form>
            </div>
        </section>
    ...
    <script>
    const updateTeacherUrl = "{{ route('teachers-update', $teacher->teacher_id) }}";
    </script>
    <script type="text/javascript" src="{{ asset('assets/js/teacher/edit.js') }}"></script>
